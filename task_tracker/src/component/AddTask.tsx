...
export default function AddTask({close, task, onchange, publish, setDeadline, setTitle, setDescription}: Prop) {
  return (
      <div className="h-screen w-screen flex justify-center p-2 items-center fixed top-0 left-0 right-0 z-10">
          ...
          >
              ...
              <div className=" border rounded-sm w-full p-2  h-52 bg-white">
                  ...
                  <span className=''>
                      <button className=' float-right px-5 p-1 rounded-3xl border-purple-500 border' onClick={publish}>
                            Send
                      </button>
                 </span>
                  </div>
